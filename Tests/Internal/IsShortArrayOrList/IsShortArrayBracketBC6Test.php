 ...
 * @since 1.0.0
 */
final class IsShortArrayBracketBC6Test extends UtilityMethodTestCase
{
    ...
    public static function dataIsShortArrayBracket()
    {
        return [
            'issue-1971-short-list-first-in-file' => [
                'testMarker' => '/* testTokenizerIssue1971PHPCSlt330gt271K */',
                'expected'   => IsShortArrayOrList::SHORT_LIST,
            ],
            'issue-1971-short-list-first-in-file-nested' => [
                'testMarker' => '/* testTokenizerIssue1971PHPCSlt330gt271L */',
                'expected'   => IsShortArrayOrList::SHORT_LIST,
            ],
        ];
    }
